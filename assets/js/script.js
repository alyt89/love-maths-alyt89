...
function checkAnswer() {
    ...
    if (isCorrect) {
    alert("Well done, you got the right answer!");
    incrementScore();
    }

    else {
    alert(`Unlucky, that wasn't quite right! You answered ${userAnswer} The correct answer was ${calculatedAnswer[0]}`);
...
/**
 * Gets the operands (the numbers) and the operand (add, subtract etc.)
